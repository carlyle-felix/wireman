...
wireman.o: ${SRC}/wireman.c ${INCL}/root.h ${INCL}/interface.h ${INCL}/manager.h ${INCL}/util.h
	gcc -c ${SRC}/wireman.c
...
manager.o: ${SRC}/manager.c ${INCL}/manager.h ${INCL}/root.h ${INCL}/wireguard.h ${INCL}/util.h
	gcc -c ${SRC}/manager.c
